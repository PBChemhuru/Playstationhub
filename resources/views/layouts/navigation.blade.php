                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        @if (Auth::user()->role === 'admin')
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <x-nav-link :href="route('getCatalogue')" :active="request()->routeIs('getCatalogue')">
                                    {{ __('Catalogue') }}
                                </x-nav-link>
                        ...
                        @else
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <x-nav-link :href="route('hotsales')" :active="request()->routeIs('hotsales')">
                                    {{ __('Sales') }}
                                </x-nav-link>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    ...
                    <x-nav-link :href="route('userin')" :active="request()->routeIs('userin')">
                        {{ __('Login') }}
                    </x-nav-link>
                    <x-nav-link :href="route('registeration')" :active="request()->routeIs('registeration')">
                        {{ __('Register') }}
                    </x-nav-link>
                    <x-nav-link :href="route('contactus')" :active="request()->routeIs('contactus')">
                        {{ __('Contact Us') }}
